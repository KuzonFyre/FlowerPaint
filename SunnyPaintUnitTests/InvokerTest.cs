...
public class InvokerTests
{
    ...
    [Fact]
    public void Stop_ShouldStopWorkerThread()
    {
        // Arrange
        var invoker = new Invoker();
        invoker.Start();
        ...
        // Assert
        Assert.False(invoker.GetWorkerThread().IsAlive);
    }
    ...
    public void Undo_WhenUndoStackNotEmpty_ShouldExecuteUndo()
    {
        ...
        // Assert
        Assert.Equal(initialCount - 1, invoker.GetUndoStackCount());
    ...
    public void Redo_WhenRedoStackNotEmpty_ShouldExecuteRedo()
    {
        ...
        // Assert
        Assert.Equal(initialCount - 1, invoker.GetRedoStackCount());
        Assert.Equal(1, invoker.GetUndoStackCount());
    }
